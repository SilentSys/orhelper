    ...
    def run_simulation(self, sim, listeners=None):
        ...
        if listeners == None:
            ...
            listener_array = jpype.JArray(
                self.orp.simulation.listeners.AbstractSimulationListener, 1
            )(0)
        else:
            listener_array = [
                jpype.JProxy(
